package com.tapestry.stackoverflowclone.services;

import com.tapestry.stackoverflowclone.dao.AnswerDao;
import com.tapestry.stackoverflowclone.dao.AnswerDaoImpl;
import com.tapestry.stackoverflowclone.dao.QuestionDao;
import com.tapestry.stackoverflowclone.dao.QuestionDaoImpl;
import com.tapestry.stackoverflowclone.dao.UserDao;
import com.tapestry.stackoverflowclone.dao.UserDaoImpl;
import com.tapestry.stackoverflowclone.restser.QuestionWebService;
import com.tapestry.stackoverflowclone.restser.QuestionWebServiceInterface;
...
public class AppModule {
    ...
    public static void bind(ServiceBinder binder) {
        binder.bind(AnswerDao.class, AnswerDaoImpl.class);
        binder.bind(QuestionDao.class, QuestionDaoImpl.class);
        binder.bind(UserDao.class, UserDaoImpl.class);

        binder.bind(QuestionWebServiceInterface.class, QuestionWebService.class);
...
//		configuration.add(SymbolConstants.BOOTSTRAP_ROOT, "context:mybootstrap");
    ...
    public static void configureRestResources(Configuration<Object> singletons,
            QuestionWebServiceInterface drzaveWeb) {
